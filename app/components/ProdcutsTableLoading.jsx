                ...
                >
                    ...
                    <div className='flex items-center justify-between'>
                      <div className='flex items-center space-x-3'>
                        ...
                        <div className='space-y-2'>
                          ...
                          <div className='h-3 w-16 skeltoin rounded'></div>
                        </div>
                      </div>
                      <div className='flex space-x-2'>
                        <div className='h-4 w-8 skeltoin rounded'></div>
                      </div>
                    </div>
                  ...
                  <td className='hidden md:table-cell px-6 py-4 whitespace-nowrap border-b border-gray-700'>
                    <div className='flex items-center'>
                      <div className='w-12 h-12 rounded-full skeltoin'></div>
                      <div className='ml-4 h-4 w-32 skeltoin rounded'></div>
                    </div>
                  </td>
                  <td className='hidden md:table-cell px-6 py-4 whitespace-nowrap border-b border-gray-700'>
                      <div className='h-4 w-24 skeltoin rounded'></div>
...
export default ProdcutsTableLoading;
